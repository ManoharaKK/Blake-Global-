      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10">
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <div className="pt-2 flex items-center gap-2 text-xs text-gray-400 font-medium">
              <span className="w-2 h-2 bg-[#4174D6]"></span>
          ...
          {/* Quick Links Column */}
          <div>
            <h4 className="text-sm font-bold text-white uppercase tracking-wider mb-4 border-l-2 border-[#4174D6] pl-3">
              Quick Links
            </h4>
            <ul className="space-y-2.5 text-sm text-gray-400">
              ...
              <li>
                <Link href="/#mission" className="hover:text-[#4174D6] transition-colors">Mission & Vision</Link>
              </li>
              <li>
                <Link href="/#about" className="hover:text-[#4174D6] transition-colors">Mother Company</Link>
              </li>
              <li>
                <Link href="/#contact" className="hover:text-[#4174D6] transition-colors">Contact Us</Link>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm text-gray-400">
              <li>
                <Link href="/terms" className="hover:text-[#4174D6] transition-colors">Terms of Service</Link>
              </li>
              <li>
                <Link href="/refund-policy" className="hover:text-[#4174D6] transition-colors">Refund & Returns Policy</Link>
              </li>
              <li>
                <Link href="/privacy-policy" className="hover:text-[#4174D6] transition-colors">Privacy Policy</Link>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="space-y-3 text-sm text-gray-400">
              ...
              <div>
                ...
                <a href="https://wa.me/94771234567" target="_blank" rel="noopener noreferrer" className="text-[#4174D6] font-semibold hover:underline block mt-0.5">
        ...
        <div className="mt-12 pt-8 border-t border-gray-800 flex flex-col sm:flex-row items-center justify-between text-xs text-gray-500 gap-4">
          ...
          <div className="flex items-center gap-4 text-gray-400">
            ...
            <span>•</span>
            <Link href="/refund-policy" className="hover:text-[#4174D6]">Refunds</Link>
            <span>•</span>
            <Link href="/privacy-policy" className="hover:text-[#4174D6]">Privacy</Link>
          </div>
        </div>
      </div>
    </footer>
